...
// 텍스처
LPDIRECT3DTEXTURE9		gpStoneDM = NULL;//디퓨즈맵
LPDIRECT3DTEXTURE9		gpStoneSM = NULL;//스페큘러맵
LPDIRECT3DTEXTURE9		gpStoneNM = NULL;//노말맵
LPDIRECT3DCUBETEXTURE9	gpSnowENV = NULL;//환경맵

// 프로그램 이름
const char*				gAppName = "Demo";
