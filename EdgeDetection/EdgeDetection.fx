...
// EnvironmentMapping
//--------------------------------------------------------------//
string EdgeDetection_EnvironmentMapping_Model : ModelData = "..\\DxFramework\\Teapot.x";
...
VS_OUTPUT EdgeDetection_EnvironmentMapping_Vertex_Shader_vs_main( VS_INPUT input )
{
   VS_OUTPUT Output;
...
float4 EdgeDetection_EnvironmentMapping_Pixel_Shader_ps_main(PS_INPUT input) : COLOR
{
...
// NoEffect
//--------------------------------------------------------------//
string EdgeDetection_NoEffect_ScreenAlignedQuad : ModelData = "..\\..\\..\\..\\..\\Program Files (x86)\\AMD\\RenderMonkey 1.82\\Examples\\Media\\Models\\ScreenAlignedQuad.3ds";

float4x4 matViewProjection;

struct EdgeDetection_NoEffect_Vertex_Shader_VS_INPUT 
{
...
struct EdgeDetection_NoEffect_Vertex_Shader_VS_OUTPUT 
{
   float4 position : POSITION0;
   float2 uv : TEXCOORD0;
};

EdgeDetection_NoEffect_Vertex_Shader_VS_OUTPUT EdgeDetection_NoEffect_Vertex_Shader_vs_main( EdgeDetection_NoEffect_Vertex_Shader_VS_INPUT input )
{
   EdgeDetection_NoEffect_Vertex_Shader_VS_OUTPUT output;
...
struct EdgeDetection_NoEffect_Pixel_Shader_PS_INPUT
{
   float2 uv : TEXCOORD0;
};
...
float4 EdgeDetection_NoEffect_Pixel_Shader_ps_main(EdgeDetection_NoEffect_Pixel_Shader_PS_INPUT input) : COLOR0
{   
...
float4x4 EdgeDetection_EdgeDetection_Vertex_Shader_matViewProjection;

struct EdgeDetection_EdgeDetection_Vertex_Shader_VS_INPUT 
{
   float4 position : POSITION0;
   float2 uv : TEXCOORD0;
...
struct EdgeDetection_EdgeDetection_Vertex_Shader_VS_OUTPUT 
{
   float4 position : POSITION0;
   float2 uv : TEXCOORD0;
};

EdgeDetection_EdgeDetection_Vertex_Shader_VS_OUTPUT EdgeDetection_EdgeDetection_Vertex_Shader_vs_main( EdgeDetection_EdgeDetection_Vertex_Shader_VS_INPUT input )
{
   EdgeDetection_EdgeDetection_Vertex_Shader_VS_OUTPUT output;
...
struct EdgeDetection_EdgeDetection_Pixel_Shader_PS_INPUT
{
   float2 uv : TEXCOORD0;
};

sampler2D EdgeDetection_EdgeDetection_Pixel_Shader_sceneSampler = sampler_state
{
   Texture = (SceneTexture_Tex);
};
...
float4 EdgeDetection_EdgeDetection_Pixel_Shader_ps_main(EdgeDetection_EdgeDetection_Pixel_Shader_PS_INPUT input) : COLOR0
{   
   float Lx = 0;
   float Ly = 0;
   for(int y=-1;y<=1;y++)
   {
      for(int x=-1;x<=1;x++)
      {
         ...
         float3 tex = tex2D(EdgeDetection_EdgeDetection_Pixel_Shader_sceneSampler, input.uv+offset).rgb;
...
technique EdgeDetection
{
   ...
   >
   {
      VertexShader = compile vs_2_0 EdgeDetection_EnvironmentMapping_Vertex_Shader_vs_main();
      PixelShader = compile ps_2_0 EdgeDetection_EnvironmentMapping_Pixel_Shader_ps_main();
   }
   ...
   pass NoEffect
   {
      ...
      VertexShader = compile vs_2_0 EdgeDetection_NoEffect_Vertex_Shader_vs_main();
      PixelShader = compile ps_2_0 EdgeDetection_NoEffect_Pixel_Shader_ps_main();
   }
