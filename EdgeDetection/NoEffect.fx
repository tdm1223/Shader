...
// EnvironmentMapping
//--------------------------------------------------------------//
string NoEffect_EnvironmentMapping_Model : ModelData = "..\\DxFramework\\Teapot.x";
...
VS_OUTPUT NoEffect_EnvironmentMapping_Vertex_Shader_vs_main( VS_INPUT input )
{
   VS_OUTPUT Output;
...
float4 NoEffect_EnvironmentMapping_Pixel_Shader_ps_main(PS_INPUT input) : COLOR
{
...
// NoEffect
//--------------------------------------------------------------//
string NoEffect_NoEffect_ScreenAlignedQuad : ModelData = "..\\..\\..\\..\\..\\Program Files (x86)\\AMD\\RenderMonkey 1.82\\Examples\\Media\\Models\\ScreenAlignedQuad.3ds";

float4x4 matViewProjection;

struct NoEffect_NoEffect_Vertex_Shader_VS_INPUT 
{
...
struct NoEffect_NoEffect_Vertex_Shader_VS_OUTPUT 
{
   float4 position : POSITION0;
   float2 uv : TEXCOORD0;
};

NoEffect_NoEffect_Vertex_Shader_VS_OUTPUT NoEffect_NoEffect_Vertex_Shader_vs_main( NoEffect_NoEffect_Vertex_Shader_VS_INPUT input )
{
   NoEffect_NoEffect_Vertex_Shader_VS_OUTPUT output;
...
struct NoEffect_NoEffect_Pixel_Shader_PS_INPUT
{
   float2 uv : TEXCOORD0;
};
...
float4 NoEffect_NoEffect_Pixel_Shader_ps_main(NoEffect_NoEffect_Pixel_Shader_PS_INPUT input) : COLOR0
{   
...
//--------------------------------------------------------------//
// Technique Section for NoEffect
//--------------------------------------------------------------//
technique NoEffect
{
   ...
   >
   {
      VertexShader = compile vs_2_0 NoEffect_EnvironmentMapping_Vertex_Shader_vs_main();
      PixelShader = compile ps_2_0 NoEffect_EnvironmentMapping_Pixel_Shader_ps_main();
   }
   ...
   pass NoEffect
   {
      ...
      VertexShader = compile vs_2_0 NoEffect_NoEffect_Vertex_Shader_vs_main();
      PixelShader = compile ps_2_0 NoEffect_NoEffect_Pixel_Shader_ps_main();
   }
