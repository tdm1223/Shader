...
VS_OUTPUT Sepia_EnvironmentMapping_Vertex_Shader_vs_main( VS_INPUT input )
{
   VS_OUTPUT Output;
...
float4 Sepia_EnvironmentMapping_Pixel_Shader_ps_main(PS_INPUT input) : COLOR
{
...
struct Sepia_Sepia_Vertex_Shader_VS_OUTPUT 
{
   float4 position : POSITION0;
   float2 uv : TEXCOORD0;
};

Sepia_Sepia_Vertex_Shader_VS_OUTPUT Sepia_Sepia_Vertex_Shader_vs_main( Sepia_Sepia_Vertex_Shader_VS_INPUT input )
{
   Sepia_Sepia_Vertex_Shader_VS_OUTPUT output;
...
struct Sepia_Sepia_Pixel_Shader_PS_INPUT
{
   float2 uv : TEXCOORD0;
};
...
float4 Sepia_Sepia_Pixel_Shader_ps_main(Sepia_Sepia_Pixel_Shader_PS_INPUT input) : COLOR0
{   
...
technique Sepia
{
   ...
   >
   {
      VertexShader = compile vs_2_0 Sepia_EnvironmentMapping_Vertex_Shader_vs_main();
      PixelShader = compile ps_2_0 Sepia_EnvironmentMapping_Pixel_Shader_ps_main();
   }
   ...
   pass Sepia
   {
      ...
      VertexShader = compile vs_2_0 Sepia_Sepia_Vertex_Shader_vs_main();
      PixelShader = compile ps_2_0 Sepia_Sepia_Pixel_Shader_ps_main();
   }
