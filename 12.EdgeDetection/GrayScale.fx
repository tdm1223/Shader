...
VS_OUTPUT GrayScale_EnvironmentMapping_Vertex_Shader_vs_main( VS_INPUT input )
{
   VS_OUTPUT Output;
...
float4 GrayScale_EnvironmentMapping_Pixel_Shader_ps_main(PS_INPUT input) : COLOR
{
...
// Grayscale
//--------------------------------------------------------------//
string GrayScale_Grayscale_ScreenAlignedQuad : ModelData = "..\\..\\..\\..\\..\\Program Files (x86)\\AMD\\RenderMonkey 1.82\\Examples\\Media\\Models\\ScreenAlignedQuad.3ds";

float4x4 matViewProjection;

struct GrayScale_Grayscale_Vertex_Shader_VS_INPUT 
{
...
struct GrayScale_Grayscale_Vertex_Shader_VS_OUTPUT 
{
   float4 position : POSITION0;
   float2 uv : TEXCOORD0;
};

GrayScale_Grayscale_Vertex_Shader_VS_OUTPUT GrayScale_Grayscale_Vertex_Shader_vs_main( GrayScale_Grayscale_Vertex_Shader_VS_INPUT input )
{
   GrayScale_Grayscale_Vertex_Shader_VS_OUTPUT output;
...
struct GrayScale_Grayscale_Pixel_Shader_PS_INPUT
{
   float2 uv : TEXCOORD0;
};
...
float4 GrayScale_Grayscale_Pixel_Shader_ps_main(GrayScale_Grayscale_Pixel_Shader_PS_INPUT input) : COLOR0
{   
...
//--------------------------------------------------------------//
// Technique Section for GrayScale
//--------------------------------------------------------------//
technique GrayScale
{
   ...
   >
   {
      VertexShader = compile vs_2_0 GrayScale_EnvironmentMapping_Vertex_Shader_vs_main();
      PixelShader = compile ps_2_0 GrayScale_EnvironmentMapping_Pixel_Shader_ps_main();
   }
   ...
   pass Grayscale
   {
      ...
      VertexShader = compile vs_2_0 GrayScale_Grayscale_Vertex_Shader_vs_main();
      PixelShader = compile ps_2_0 GrayScale_Grayscale_Pixel_Shader_ps_main();
   }
